...
//  JerusalemHotspots
//
//  Created by Elan Kainen on 3/31/20.
//  Copyright © 2020 Elazar Gavur. All rights reserved.
//
...
class ThemeViewController: UIViewController, MGLMapViewDelegate, CLLocationManagerDelegate {
    ...
    var centerCoordinate = CLLocationCoordinate2D(latitude: 31.800140, longitude: 35.238510) // This will serve as the center coordinate if the user denies location permissions.
    
    
//     var centerCoordinate = CLLocationCoordinate2D(latitude: 40.7478, longitude: -73.9898)
    ...
    override func viewDidLoad() {
        ...
        //mapView.zoomLevel = 15
           ...
           mapView.setCenter(centerCoordinate, zoomLevel: 12, animated: false)      // MARK: To center on the user's location, comment this line out and uncomment the following line.
    ...
    func getIndexForFeature(feature: MGLPointFeature) -> Int {
        // Filter the features based on a unique attribute. In this case, the location's Name is used.
...
class CustomItemView : UIView {
    ...
    public func updateLabels() {
        ...
        if let Type : String = selectedFeature.attribute(forKey: "Type") as? String {
            containerView.itemHourLabel.text = Type
        }
        if let Neighborhood : String = selectedFeature.attribute(forKey: "Neighborhood") as? String  {
            containerView.itemDescriptionLabel.text = Neighborhood
        }
        
        if let Utility : String = selectedFeature.attribute(forKey: "Utility") as? String  {
            containerView.itemPhoneNumberLabel.text = Utility
        }
    }
